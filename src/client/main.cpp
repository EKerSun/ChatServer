...
// User g_current_user;
// // 记录当前登录用户的好友列表信息
// vector<User> g_current_user_friend_list;
// // 记录当前登录用户的群组列表信息
// vector<Group> g_current_user_group_list;
// // 控制主菜单页面程序
// bool is_main_menu_running = false;
// // 用于读写线程之间的通信
// sem_t rwsem;
// // 记录登录状态
// atomic_bool g_is_login_success{false};
...
//     // 连接服务器成功，启动接收子线程
//     std::thread read_tesk(ReadTaskHandler, clientfd); // pthread_create
//     read_tesk.detach();                               // pthread_detach
...
// {
//     if (0 != responsejs["errno"].get<int>()) // 添加失败
//     {
...
// void CreateGroupResponse(json &responsejs)
// {
//     if (0 != responsejs["errno"].get<int>()) // 添加失败
//     {
...
//     else // 注册成功
//     {
//         cout << "Create Group success" << endl;
//     }
// }

// void AddGroupResponse(json &responsejs)
// {
//     if (0 != responsejs["errno"].get<int>()) // 添加失败
//     {
...
//     cout << "current login user => id:" << g_current_user.GetID() << " name:" << g_current_user.GetName() << endl;
//     cout << "----------------------friend list---------------------" << endl;
//     if (!g_current_user_friend_list.empty())
//     {
//         for (User &user : g_current_user_friend_list)
//         {
...
//     {
//         for (Group &group : g_current_user_group_list)
//         {
